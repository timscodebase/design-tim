<script lang="ts">
	...
	$ogStore.banner = banner
	$ogStore.description = description
	$ogStore.name = name
	$ogStore.url = url
</script>
...
<svelte:head>
	...
	<meta name="twitter:card" content={`${$ogStore.name}: ${$ogStore.description}`} />
	<meta name="twitter:site" content="@timsmith23" />
	<meta name="twitter:creator" content="@timsmith23" />
	<meta property="og:title" content={$ogStore.description} />
	<meta property="og:type" content="website" />
	<meta property="og:url" content="https://timsmith.tech" />
	<meta property="og:description" content={`${$ogStore.name}: ${$ogStore.description}`} />
	<meta property="og:site_name" content={`${$ogStore.name}: ${$ogStore.description}`} />
	<meta property="og:image" href={`${$ogStore.url}${$ogStore.banner}`} />
