<script lang="ts">
	...
	// function that takes in a width and respecting the aspect ratio, returns the height
	function getHeight(width: number) {
		return width / 1.1228
	}
</script>

<svg {width} height={getHeight(width)} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 452 520">
